...
s0_mode_matches = 
s0_mode_modes = 
s0_viewport_matches = class=Gnome-terminal;class=Firefox;class=Google-chrome;
s0_viewport_x_values = 1;2;2;
s0_viewport_y_values = 2;1;2;
...
[core]
s0_active_plugins = core;bailer;detection;composite;opengl;compiztoolbox;decor;mousepoll;place;session;wall;move;snap;resize;vpswitch;gnomecompat;put;imgpng;grid;regex;animation;workarounds;expo;ezoom;staticswitcher;fade;switcher;scale;unityshell;
...
s0_urgent_animation = 0
s0_panel_opacity = 1.000000
s0_launcher_opacity = 0.900000
s0_icon_size = 40
